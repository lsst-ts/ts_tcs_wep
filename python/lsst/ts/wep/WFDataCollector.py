...
class WFDataCollectorTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Destination folder
        destinationPath = os.path.join(self.modulePath, "test")

        # Butler
        butlerInputs = butlerOutputs = destinationPath
    ...
    def testFunction(self):
        ...
        dbAdress = os.path.join(self.modulePath, "test", "registry.sqlite3")
        ...
        # Import the PhoSim simulated image
        dataDir = os.path.join("real", "output")
        atype = "raw"
